...
public class KAWKPSPublicSoap
{
    ...
    public KAWKPSPublicSoap(){}

    public KAWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KAWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KAWExtendedSoapSerializationEnvelope envelope= new KAWExtendedSoapSerializationEnvelope(KAWExtendedSoapSerializationEnvelope.VER11);
